...
<div class="col-lg-8">
    ...
    <form method="post" action="{{ route('admin.comics.store') }}" class="mb-5" enctype="multipart/form-data"> 
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('author_id') is-invalid @enderror" id="author_id" name="author_id" value="{{ old('author_id') }}">
            @error('author_id')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
